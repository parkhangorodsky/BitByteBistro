...
public class CoreFunctionalityInteractorTest {
    ...
    void testGetGroceryListNoExistingIngredients() {
        ...
        // Act
        ShoppingList result = interactor.getGroceryList(recipe, shoppingList);

        // Assert
        assertEquals(1, result.getListItems().size());
        assertEquals(ingredient, result.getListItems().get(0));
    }
    ...
    void testGetGroceryListWithExistingIngredients() {
        ...
        assertEquals("Tomato", result.getListItems().get(0).getIngredientName());
        assertEquals(2, result.getListItems().get(0).getQuantity());
    }
}
