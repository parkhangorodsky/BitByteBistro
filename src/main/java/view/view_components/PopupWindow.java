...
public class PopupWindow extends JFrame implements ThemedComponent {
    ...
    protected void positionFrameAtCenter(JFrame childFrame, JFrame parentFrame) {
        ...
        int newX = parentX + (parentWidth - childFrame.getWidth()) / 2;
        int newY = parentY + (parentHeight - childFrame.getHeight()) / 2;

        childFrame.setLocation(newX, newY);
    }
